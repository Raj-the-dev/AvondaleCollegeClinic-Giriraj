...
namespace AvondaleCollegeClinic.Migrations
{
    ...
    [Migration("20251020203837_RemovePhonefield")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AvondaleCollegeClinic.Areas.Identity.Data.AvondaleCollegeClinicUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "18895624-0479-47bc-9773-b6810b862169",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFbFgy2knDjWdiLE2eCfTBSjh/w1w61pJo7bzAxfEK8zZwCIc47ujU0KS8vWkEF41g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e6f58734-1661-446c-92c1-17af0b0f1b09",
            ...
            modelBuilder.Entity("AvondaleCollegeClinic.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Sam",
                            HomeroomID = "hr250001",
                            ImagePath = "/images/students/1.jpg",
                            LastName = "Hill"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("StudentCaregivers", b =>
                {
                    b.Property<string>("StudentID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("StudentID", "CaregiverID");

                    b.HasIndex("CaregiverID");

                    b.ToTable("StudentCaregivers", (string)null);
            ...
            modelBuilder.Entity("AvondaleCollegeClinic.Models.Homeroom", b =>
                {
                    b.HasOne("AvondaleCollegeClinic.Models.Teacher", "Teacher")
                        .WithOne("Homeroom")
                        .HasForeignKey("AvondaleCollegeClinic.Models.Homeroom", "TeacherID")
            ...
            modelBuilder.Entity("StudentCaregivers", b =>
                {
                    b.HasOne("AvondaleCollegeClinic.Models.Caregiver", null)
                        .WithMany()
                    ...
                    b.HasOne("AvondaleCollegeClinic.Models.Student", null)
                        .WithMany()
                        .HasForeignKey("StudentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
